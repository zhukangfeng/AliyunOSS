...
class OSS {
    ...
    public static function upload($ossKey, $filePath)
    {
        ...
        $oss->ossClient->setBucket('your-bucket-name');
    ...
    public static function deleteObject($ossKey)
    {
        ...
        return $oss->ossClient->deleteObject(null, $ossKey);
    }
    ...
    public function copyObject($sourceBuckt, $sourceKey, $destBucket, $destKey)
    {
        ...
        return $oss->ossClient->copyObject(null, $sourceKey, null, $destKey);
    }
    ...
    public function moveObject($sourceBuckt, $sourceKey, $destBucket, $destKey)
    {
        ...
        return $oss->ossClient->moveObject(null, $sourceKey, null, $destKey);
    }
